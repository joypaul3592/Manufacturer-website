...
const Team = () => {
    return (
        <div>
            <section class="bg-white max-w-7xl mx-auto px-5 py-20 pb0">
                <div class="container px-6 py-10 mx-auto">
                    <h1 class="text-3xl font-semibold text-center text-green-400 capitalize lg:text-4xl ">Our Executive Team</h1>

                    <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 ">Our Executive team help to find the best products, help to find the best soluetion for best purpose and find the provlem solving.
                    </p>
