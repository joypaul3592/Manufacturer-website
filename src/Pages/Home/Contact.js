...
function Contact() {
    ...
    return (
        <div className="w-full bg-red-500 my-36" style={{ backgroundImage: `url(${contactBannar})`, backgroundSize: 'cover' }
        }>
                    ...
                    <div className=" w-full bg-white backdrop-blur-lg bg-opacity-10 shadow-lg rounded py-12 lg:px-28 px-8">
                        ...
                        <div className="md:flex items-center mt-12">
                            <div className="md:w-1/2 flex flex-col ">
                                <label className="text-base font-semibold leading-none text-gray-50">Name</label>
                            ...
                            <div className="md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                                <label className="text-base font-semibold leading-none text-gray-50">Email Address</label>
                        ...
                        <div className="md:flex items-center mt-8 w-full">
                            <div className="md:w-1/2 flex flex-col">
                                <label className="text-base font-semibold leading-none text-gray-50">Company name</label>
                            ...
                            <div className="md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                                <label className="text-base font-semibold leading-none text-gray-50">Country</label>
                        ...
                        <div>
                            <div className="w-full flex flex-col mt-8">
                                <label className="text-base font-semibold leading-none text-gray-50">Message</label>
